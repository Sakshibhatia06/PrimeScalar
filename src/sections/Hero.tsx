...
const sectionRef=useRef(null);
  ...
  transition={{
    ...
    <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,0.36,.5)_78%,transparent)]"></div>
    {/* Start Planet */}
    ...
    transition={{
      ...
      <div className="absolute h-5 w-5 top-0 left-full border border-white rounded-full -translate-x-1/2 -translate-y-1/2 inline-flex items-center justify-center">
    ...
    <div className="container relative mt-16">
      ...
      <p className="text-lg md:text-xl text-white/70 mt-5 text-center max-w-xl mx-auto">Scaling 6–9 figure businesses to 20x growth.</p>
