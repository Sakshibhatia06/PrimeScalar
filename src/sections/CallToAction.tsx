    ...
    <div className="container">
      <div className="border border-white/15 py-24 rounded-xl overflow-hidden relative" style={{
        ...
        <div className="relative">
          ...
          <p className="text-center text-lg md:text-xl max-w-sm mx-auto text-white/70 px-4 mt-5 tracking-tight">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Saepe ratione sint illo! Quos quaerat</p>
